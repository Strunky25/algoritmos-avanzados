...
//        graph.drawLine(lastX, PANEL_SIZE - lastY2, x, PANEL_SIZE - y3);
        //graph.fillOval(x - POINT_DIAMETER/2, PANEL_SIZE - (y + POINT_DIAMETER/2), POINT_DIAMETER, POINT_DIAMETER);
        lastX = x;
        lastY1 = y1;
        lastY2 = y2;
        lastY3 = y3;
...
//        graph.drawString("Mixed", lastX + TEXT_PADDING, y3 + TEXT_PADDING);
    ...
    public boolean getInputSize(){
        ...
        content.add(spin);
        int option = JOptionPane.showOptionDialog(null, content, "Choose Test Size", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
